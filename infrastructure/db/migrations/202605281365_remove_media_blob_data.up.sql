...
INSERT INTO media_attachments_new (id, created_at, updated_at, local_account_id, file_name, content_type, storage_path, description)
...
ALTER TABLE media_attachments_new RENAME TO media_attachments;
